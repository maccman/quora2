...
$.fn.item = function(){
  var item = $(this).data("item") || $(this).tmplItem().data;
...
Manager.include({
  ...
  add: function(controller){
    ...
    controller.bind("active", this.proxy(function(){
...
}).call(this)({"jquery.data": function(exports, require, module) {jQuery.fn.dataAttr = function(key, value){
  return($(this).attr("data-" + key, value));
};}, "jquery.eco": function(exports, require, module) {(function($){
...
window.jQuery = window.$ = jQuery;
})(window);}, "jquery.serialajax": function(exports, require, module) {(function($){
...
})(jQuery);}, "jquery.tmpl": function(exports, require, module) {/*!
 * jQuery Templates Plugin 1.0.0pre
 * http://github.com/jquery/jquery-tmpl
 * Requires jQuery 1.4.2
 *
...
})( jQuery );}, "json2": function(exports, require, module) {/*
    http://www.JSON.org/json2.js
    2009-09-29
...
}());}, "shim": function(exports, require, module) {(function(){var j=Object.prototype.hasOwnProperty;if(!Array.isArray)Array.isArray=function(a){return Object.prototype.toString.call(a)=="[object Array]"};if(!Array.prototype.forEach)Array.prototype.forEach=function(a,c){for(var b=this.length>>>0,d=0;d<b;d++)d in this&&a.call(c,this[d],d,this)};if(!Array.prototype.map)Array.prototype.map=function(a,c){var b=this.length>>>0;if(typeof a!="function")throw new TypeError;for(var d=Array(b),e=0;e<b;e++)if(e in this)d[e]=a.call(c,this[e],e,this);return d};
if(!Array.prototype.filter)Array.prototype.filter=function(a,c){for(var b=[],d=0;d<this.length;d++)a.call(c,this[d])&&b.push(this[d]);return b};if(!Array.prototype.every)Array.prototype.every=function(a,c){for(var b=0;b<this.length;b++)if(!a.call(c,this[b]))return false;return true};if(!Array.prototype.some)Array.prototype.some=function(a,c){for(var b=0;b<this.length;b++)if(a.call(c,this[b]))return true;return false};if(!Array.prototype.reduce)Array.prototype.reduce=function(a){var c=this.length>>>
0;if(typeof a!="function")throw new TypeError;if(c==0&&arguments.length==1)throw new TypeError;var b=0;if(arguments.length>=2)var d=arguments[1];else{do{if(b in this){d=this[b++];break}if(++b>=c)throw new TypeError;}while(1)}for(;b<c;b++)if(b in this)d=a.call(null,d,this[b],b,this);return d};if(!Array.prototype.reduceRight)Array.prototype.reduceRight=function(a){var c=this.length>>>0;if(typeof a!="function")throw new TypeError;if(c==0&&arguments.length==1)throw new TypeError;c=c-1;if(arguments.length>=
2)var b=arguments[1];else{do{if(c in this){b=this[c--];break}if(--c<0)throw new TypeError;}while(1)}for(;c>=0;c--)if(c in this)b=a.call(null,b,this[c],c,this);return b};if(!Array.prototype.indexOf)Array.prototype.indexOf=function(a,c){var b=this.length;if(!b)return-1;var d=c||0;if(d>=b)return-1;if(d<0)d+=b;for(;d<b;d++)if(j.call(this,d))if(a===this[d])return d;return-1};if(!Array.prototype.lastIndexOf)Array.prototype.lastIndexOf=function(a,c){var b=this.length;if(!b)return-1;var d=c||b;if(d<0)d+=
b;for(d=Math.min(d,b-1);d>=0;d--)if(j.call(this,d))if(a===this[d])return d;return-1};if(!Object.getPrototypeOf)Object.getPrototypeOf=function(a){return a.__proto__||a.constructor.prototype};if(!Object.getOwnPropertyDescriptor)Object.getOwnPropertyDescriptor=function(){return{}};if(!Object.getOwnPropertyNames)Object.getOwnPropertyNames=function(a){return Object.keys(a)};if(!Object.create)Object.create=function(a,c){var b;if(a===null)b={__proto__:null};else{if(typeof a!="object")throw new TypeError("typeof prototype["+
...
"")}}})();}, "spine": function(exports, require, module) {(function(){
  ...
  Spine.App.extend(Events)
  Controller.fn.App = Spine.App;
})();}, "spine.list": function(exports, require, module) {(function(Spine, $){
...
})(Spine, Spine.$);}, "spine.manager": function(exports, require, module) {////
// A Manager is basically a state machine that controls a set of controller's 'active' state.
// In other words, you feed a manager controllers, and it'll make sure that only controller has an 'active' state at any one time. 
// This is useful whenever you're implementing tabs or separate views inside an application. 
//
...
})(Spine, Spine.$);}, "spine.model.ajax": function(exports, require, module) {(function(Spine, $){
...
})(Spine, Spine.$);}, "spine.model.local": function(exports, require, module) {Spine.Model.Local = {
  extended: function(){
    this.sync(this.proxy(this.saveLocal));
    this.fetch(this.proxy(this.loadLocal));
  },
...
};}, "spine.route": function(exports, require, module) {// Spine routing, based on Backbone's implementation.
//  Backbone.js 0.3.3
//  (c) 2010 Jeremy Ashkenas, DocumentCloud Inc.
//  Backbone may be freely distributed under the MIT license.
//  For all details and documentation:
...
})(Spine, Spine.$);}, "spine.route.shim": function(exports, require, module) {var Spine = require("spine");
...
Spine.Controller.fn.navigate = function(){
  Spine.Route.navigate.apply(Spine.Route, arguments);
};}, "spine.tabs": function(exports, require, module) {// Usage:
  ...
  Spine.Tabs = Spine.Controller.create({
    ...
    connect: function(tabName, controller) {
      this.bind("change", function(name){
        if (name == tabName)
          (controller.active || controller).apply(controller);
      });
    },
...
})(Spine, Spine.$);}, "spine.tmpl": function(exports, require, module) {// jQuery.tmpl.js utilities
...
$.fn.forItem = function(item){
...
})(jQuery);}, "spine.touch": function(exports, require, module) {(function(Spine, $){
  ...
  module.exports = Spine.Controller.create({
    ...
    init: function() {
      ...
      this.searches = Searches.init({
        el: this.searches
      });
      this.footer = Footer.init({
        el: this.footer
      });
      Spine.Manager.init(this.answers, this.searches);
      this.sidebar.bind("change", __bind(function(item) {
        return this.answers.active(item);
      }, this));
      this.searches.bind("change", __bind(function(item) {
        this.sidebar.active(item);
        return this.answers.active(item);
      }, this));
      return $.getJSON("fixtures.json", function(data) {
        return Question.refresh(data);
      });
    }
  });
}).call(this);
}, "controllers/answers": function(exports, require, module) {(function() {
  var Answer, AnswerPrompt, AnswersList, Question;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  Question = require("models/question");
  ...
  AnswerPrompt = Spine.Prompt.create({
    ...
    template: function(items) {
      return require("views/questions/answer")(items);
    },
    submit: function(e) {
      e.preventDefault();
      this.item.answers.create({
        name: "Joe Blogs",
        body: this.body.val()
      });
  ...
  AnswersList = Spine.List.create({
    selectFirst: true,
    template: function(items) {
      return require("views/answers/list")(items);
    }
  });
  module.exports = Spine.Controller.create({
    elements: {
    ...
    init: function() {
      return Question.bind("change", __bind(function() {
        if (this.current) {
          return this.render();
        }
      }, this));
    ...
    template: function(item) {
      return require("views/questions/panel")(item);
    },
    answersTemplate: function(item) {
      return require("views/answers/show")(item);
    },
    render: function() {
      if (!this.current) {
        this.deactivate();
    ...
    renderAnswers: function() {
      ...
      answers = this.current.answers.all();
      this.answers.html(this.answersTemplate(answers));
      this.list = AnswersList.init({
        el: this.answersNav
      });
      this.list.render(answers);
    ...
    answerPrompt: function() {
      if (this.dialog) {
        this.dialog.close();
      }
      this.dialog = AnswerPrompt.init({
        item: this.current
      });
      this.dialog.render();
      return this.dialog.blOffset(this.answerBtn.offset());
    }
  });
}).call(this);
}, "controllers/footer": function(exports, require, module) {(function() {
  var Footer, Question, QuestionPrompt;
  Question = require("models/question");
  QuestionPrompt = Spine.Prompt.create({
    ...
    template: function(items) {
      return require("views/footer/question")(items);
    },
    submit: function(e) {
      e.preventDefault();
      Question.create({
  ...
  Footer = module.exports = Spine.Controller.create({
    ...
    questionPrompt: function() {
      ...
      this.dialog = QuestionPrompt.init();
      this.dialog.render();
      return this.dialog.blOffset(this.question.offset());
    }
  });
}).call(this);
}, "controllers/searches": function(exports, require, module) {(function() {
  var Question, Search;
  ...
  module.exports = Spine.Controller.create({
    ...
    init: function() {
      this.el.html(require("views/searches/panel")());
      this.search = Search.init(Question);
      this.search.bind("change", this.change);
      this.input = $("#searchInput");
      return this.input.bind("keyup", this.keyup);
    },
    keyup: function() {
      this.query = this.input.val();
      return this.search.query(this.query);
    },
    template: function(items) {
      return require("views/searches/list")(items);
    },
    change: function() {
      this.$(".query").text(this.query);
      this.$(".items").html(this.template(this.search.results));
      return this.active();
    },
    click: function(e) {
      var question;
      question = $(e.target).item();
      return this.trigger("change", question);
    }
  });
}).call(this);
  ...
  List = Spine.List.create({
    selectFirst: true,
    template: function(item) {
      return require("views/questions/list")(item);
    }
  });
  module.exports = Spine.Controller.create({
    elements: {
    ...
    init: function() {
      ...
      return Question.bind("change refresh", this.render);
    },
    render: function() {
      return this.list.render(Question.all());
    },
    change: function(item) {
      return this.trigger("change", item);
    },
    active: function(item) {
      return this.list.change(item);
    }
  });
}).call(this);
...
}, "lib/spine.prompt": function(exports, require, module) {(function() {
...
}, "lib/spine.relation": function(exports, require, module) {(function() {
  Spine.Model.extend({
...
}, "models/answer": function(exports, require, module) {(function() {
  var Answer;
...
}, "models/question": function(exports, require, module) {(function() {
  var Question;
...
}, "models/search": function(exports, require, module) {(function() {
  var Search, classMethods, instanceMethods;
  ...
  instanceMethods = {
    query: function(params) {
      ...
      attributes = (typeof this.query_atts === "function" ? this.query_atts() : void 0) || this.attributes();
      for (key in attributes) {
        value = attributes[key];
        if (value != null ? typeof value.query === "function" ? value.query(params).length : void 0 : void 0) {
          return true;
  ...
  Search.Model = {
    extended: function() {
      ...
      return this.include(instanceMethods);
    }
  };
  Search.include({
    init: function() {
    ...
    query: function(params) {
      ...
      this.models.forEach(__bind(function(model) {
        var results;
        results = model.query(this.params);
        return this.results = this.results.concat(results);
      }, this));
    ...
    each: function(callback) {
      return this.results.forEach(callback);
    }
  });
}).call(this);
}, "views/answers/list": function(exports, require, module) {var template = "<div class=\"item\">\n  ${name} \n</div>"; module.exports = (function(data){ return jQuery.tmpl(template, data); });
}, "views/answers/show": function(exports, require, module) {var template = "<div class=\"item\">\n  <div class=\"name\">${name}</div>\n  <div class=\"body\">{{html body}}</div>\n</div>"; module.exports = (function(data){ return jQuery.tmpl(template, data); });
